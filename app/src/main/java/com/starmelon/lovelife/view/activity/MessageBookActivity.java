...
/**
 * Created by starmelon on 2016/11/19 0019.
 */

public class MessageBookActivity extends AppCompatActivity implements EMChatRoomChangeListener,EMMessageListener{
    ...
    // 聊天室监听器
    private EMChatRoomChangeListener mRoomListener;
    // 消息监听器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_messagebook);

        // 获取当前会话的username(如果是群聊就是群id)
        mChatId = "266277947680228932";
        //mRoomListener = this;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    //EMClient.getInstance().groupManager().joinGroup(mChatId);
    ...
    private void joinRoom() {
        ...
        EMClient.getInstance().chatroomManager().joinChatRoom(mChatId, new EMValueCallBack<EMChatRoom>() {
            @Override
            public void onSuccess(EMChatRoom emChatRoom) {
                //加入聊天室成功
                Toast.makeText(MessageBookActivity.this,"成功进入留言大厅",Toast.LENGTH_SHORT).show();
                initConversation();
            }
            ...
            public void onError(int i, String s) {
                //加入聊天室失败
                Toast.makeText(MessageBookActivity.this,"无法进入留言大厅",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    protected void onResume() {
        super.onResume();
        // 添加聊天室监听
        //EMClient.getInstance().chatroomManager().addChatRoomChangeListener(mRoomListener);
        // 添加消息监听
    ...
    protected void onStop() {
        ...
        //添加聊天室监听
        //EMClient.getInstance().chatroomManager().removeChatRoomChangeListener(mRoomListener);
        // 移除消息监听
